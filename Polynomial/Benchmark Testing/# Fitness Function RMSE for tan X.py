# Fitness Function RMSE for tan X
import numpy as np
                    ...
                    for nrb in nrb_values:
                        for ngh in ngh_values:
                            for stlim in stlim_values:
                                coeffs, fitness_history = bees_algorithm(tan_func, x_range, degree, ns, ne, nb, nre, nrb, ngh, stlim)
...
best_coeffs, fitness_history = bees_algorithm(tan_func, x_range, degree, ns, ne, nb, nre, nrb, ngh, stlim)
